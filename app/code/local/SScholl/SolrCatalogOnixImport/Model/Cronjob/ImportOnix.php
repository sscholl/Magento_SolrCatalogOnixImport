...
class SScholl_SolrCatalogOnixImport_Model_Cronjob_ImportOnix
	extends SScholl_SolrCatalogOnixImport_Model_Cronjob_Abstract
{
	...
	/**
	 * cron:			sschollsolrcatalogoniximport_convert_onix
	 * shedule-time:	* * * * *
	 */
	protected function _processFile($fileName)
	{
		...
		if ($onix->lock()) {
			if ( ($books = $onix->getBooks()) ) {
				/* @var $onix SScholl_SolrCatalogOnixImport_Model_Import */
				$import = Mage::getModel('sschollsolrcatalogoniximport/import');
