...
class SScholl_SolrCatalogOnixImport_Helper_Config
{
	...
	private function _getImportFolder($file = '')
	{
		...
		return Mage::getStoreConfig('sschollsolrcatalogoniximport/folder/import') . $file;
	}

	private function _getImportedFolder($file = '')
	{
		if ( $file ) $file = DS . $file;
		return  Mage::getStoreConfig('sschollsolrcatalogoniximport/folder/imported') . $file;
	}
